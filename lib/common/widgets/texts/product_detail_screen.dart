...
import '../../../features/shop/screens/cart/widgets/bottom_add_to_cart.dart';

class TProductDetailScreen extends StatelessWidget {
  const TProductDetailScreen({Key? key, required this.product}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const SizedBox(height: TSizes.spaceBtwItems),
            const ReadMoreText(
              'Ajoutez votre description ici. Vous pouvez ajouter autant de lignes que nécessaire pour décrire le produit en détail.',
              trimLines: 2,
